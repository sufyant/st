...
description: Add Clerk authentication to your app with the Clerk CLI. Set up, style, and customize Clerk. No need to leave your terminal or copy and paste API keys. Falls back to the docs for frameworks the CLI can't fully scaffold.
---
